(() => {
  ...
  const I18N = {
    pl: {
      ...
      // Home
      home_h1: "Projektuję premium strony, interfejsy i systemy dla marek, które mają wyglądać ostrzej i działać konkretniej.",
      home_p: "Skupione studio jednej osoby: kierunek wizualny, frontend i logika produktu w jednym miejscu — od pozycjonowania oferty po wdrożenie i polish.",
      ...
      // Home (merged from index.html inline dict)
      hero_pill_1: "Publiczny case",
      hero_pill_2: "Jasny zakres",
      hero_pill_3: "Web + systemy",
      home_cta_work: "Zobacz realizacje",
      identity_role: "Niezależne studio — web i systemy",
      proof_a_label: "Web",
      proof_a_text: "Strony firmowe z ofertą, CTA, lokalnym SEO i wdrożeniem.",
      proof_b_label: "Produkt",
      proof_b_text: "Aplikacje i prototypy pokazujące UX, logikę i assety brandowe.",
      proof_c_label: "Proces",
      proof_c_text: "Dashboardy i flow pracy projektowane pod porządek, status i decyzje.",
      trust_1_title: "Product-level polish",
      trust_1_text: "Jakość na poziomie produktu, nie szablonu.",
      trust_2_title: "System, nie losowe strony",
      trust_2_text: "Pozycjonowanie, interfejs i ścieżka konwersji.",
      trust_3_title: "Proof over claims",
      trust_3_text: "Pokazuję proces i output, nie obietnice.",
      ...
      service_web_meta: "Landing pages, multi-page sites, lokalne SEO i conversion-focused UX.",
      service_admin_meta: "Dashboardy, role, raporty, workflow i automatyzacje.",
      service_mkt_meta: "Landing + tracking + CRO + plan kampanii.",
      home_about_kicker: "O mnie",
      home_about_h2: "Niezależny builder z systemowym myśleniem",
      home_about_p: "Łączę kierunek wizualny, frontend i klarowność biznesową. Pracuję jak jednoosobowe studio: jeden właściciel projektu, jasne decyzje i output, który widać.",
      home_about_cta: "Poznaj mnie",

      // Work (merged from work.html inline dict)
      page_kicker: "Realizacje",
      page_h1: "Realizacje",
      page_p: "Wybrane prace pokazane tak, jak patrzy na nie firma: problem, zakres, moja rola i status projektu. Publiczny case jest oznaczony osobno od koncepcji i systemów prywatnych.",
      proof_live: "Publiczny URL",
      proof_demo: "Koncepcja",
      proof_own: "Mój projekt",
      proof_private: "System prywatny",
      filter_apps: "Aplikacje",
      filter_systems: "Systemy",
      filter_marketing: "Marketing",
      feature_status: "Live site",
      feature_cat: "Strona",
      feature_client: "Lokalny klient",
      feature_kicker: "Publiczny case #01",
      feature_title: "UndergroundGym.pl",
      feature_desc: "Strona lokalnej siłowni 24/7: premium first impression, czytelna oferta, cennik, opinie i pełna ścieżka kontaktu — od wejścia próbnego po formularz i mapę.",
      feature_li_1: "Oferta i CTA prowadzące bezpośrednio do wejścia próbnego.",
      feature_li_2: "Responsywny układ desktop/mobile z mocną identyfikacją klubu.",
      feature_li_3: "Zewnętrzne embed-y (mapa) schowane za zgodą — RODO-friendly.",
      feature_li_4: "SEO basics i Core Web Vitals jako standard od startu.",
      open_live: "Otwórz live site",
      role_label: "Rola:",
      proof_label: "Dowód:",
      status_label: "Status:",
      ask_scope: "Zapytaj o zakres",
      ug_title: "UndergroundGym.pl",
      ug_role: "UX + frontend + wdrożenie",
      ug_meta: "Fitness / realny klient",
      ug_desc: "Conversion-focused website dla siłowni 24/7. Oferta, cennik, opinie, formularz wejścia próbnego i kontakt z RODO-friendly embeds.",
      ug_metric: "live site / realny klient / publiczny URL",
      prime_preview_label: "Koncepcja",
      prime_status: "Koncepcja",
      prime_cat_web: "Strona",
      prime_cat_growth: "Fitness",
      prime_cat_mkt: "Repozycjonowanie",
      prime_title: "PrimeGym Rumia",
      prime_role: "Strategia oferty, UX, web design, frontend, local SEO",
      prime_meta: "Fitness / koncepcja",
      prime_desc: "Repozycjonowanie lokalnego klubu ze zwykłej siłowni na premium markę fitness-lifestyle: nowy hero, struktura oferty, grafik i cennik, ścieżki CTA oraz plan trackingu konwersji.",
      prime_li_1: "Pozycjonowanie oferty: fitness + lifestyle club, Kids Zone, Akademia Prime, wellness/sauna",
      prime_li_2: "Landing pages i struktura lokalnego SEO",
      prime_li_3: "CTA path do grafiku, karnetu, kontaktu i eFitness",
      prime_li_4: "Audyt sygnałów publicznych, mapa konkurentów i kierunki kampanii",
      prime_li_5: "Mapa zdarzeń analitycznych i plan trackingu konwersji",
      prime_stack_meta: "Plan kampanii",
      prime_stack_tracking: "Plan trackingu",
      prime_metric: "koncepcja / zbudowane i wysłane",
      prime_demo_btn: "Koncepcja, nie live",
      sudoku_preview_label: "Mój projekt",
      sudoku_status: "Mój projekt",
      ...
      trading_cat_frontend: "Frontend",
      trading_title: "Trading Workstation",
      trading_role: "Frontend architecture, UX systems, dashboard design, backend integration",
      trading_meta: "Dashboard / system prywatny",
      trading_desc: "Lokalny decision-support dashboard do konserwatywnej analizy: evidence retrieval, klasyfikacje (qualified_watchlist, weak_watchlist, no_trade), diagnostyki i przeprojektowanie UI na cockpit operacyjny.",
      trading_li_1: "Chart-first layout z prawym railem evidence i sample-count diagnostics",
      trading_li_2: "Decision classification UI z czytelną hierarchią statusów",
      trading_li_3: "Dark mode workstation/cockpit: Space Grotesk + IBM Plex Mono",
      trading_li_4: "Frontend refactor: DashboardView, RightRailSummary, ActionCard, PriceHistoryChart",
      trading_li_5: "Build/test-validated — nie jest to prezentacja wyników finansowych",
      trading_metric: "system prywatny / frontend zwalidowany testami",
      private_repo: "Prywatne repozytorium",
      tw_svg_run: "SKANUJ",
      tw_svg_decision: "DO OBSERWACJI",
      tw_svg_system: "SYSTEM WŁASNY",
},
    en: {
      // Titles / meta
      ...
      // Home
      home_h1: "I build premium websites, product interfaces, and practical systems for brands that need to look sharper and move with intent.",
      home_p: "A focused one-person studio: visual direction, frontend, and product logic in one place — from positioning the offer to deployment and polish.",
      hero_tag: "Audit • Build • Scale",
      ...
      // Home (merged from index.html inline dict)
      hero_pill_1: "Public case",
      hero_pill_2: "Clear scope",
      hero_pill_3: "Web + systems",
      home_cta_work: "See work",
      identity_role: "Independent web & systems studio",
      proof_a_label: "Web",
      proof_a_text: "Business websites with offer structure, CTAs, local SEO and deployment.",
      proof_b_label: "Product",
      proof_b_text: "Apps and prototypes that show UX, logic and brand assets.",
      proof_c_label: "Process",
      proof_c_text: "Dashboards and workflows designed around clarity, status and decisions.",
      trust_1_title: "Product-level polish",
      trust_1_text: "Quality at product level, not template level.",
      trust_2_title: "Systems, not random pages",
      trust_2_text: "Positioning, interface and a conversion path.",
      trust_3_title: "Proof over claims",
      trust_3_text: "I show process and output, not promises.",
      status_live: "Live website",
      status_demo: "Concept",
      ...
      service_web_meta: "Landing pages, multi-page sites, local SEO and conversion-focused UX.",
      service_admin_meta: "Dashboards, roles, reporting, workflows and automations.",
      service_mkt_meta: "Landing + tracking + CRO + campaign plan.",
      home_about_kicker: "About",
      home_about_h2: "An independent builder with systems thinking",
      home_about_p: "I combine visual direction, frontend, and business clarity. I work like a one-person studio: a single project owner, clear decisions, and output you can actually see.",
      home_about_cta: "About me",

      // Work (merged from work.html inline dict)
      page_kicker: "Work",
      page_h1: "Work",
      page_p: "Selected work shown from a business perspective: problem, scope, my role and project status. The public case is separated from concepts and private systems.",
      proof_live: "Public URL",
      proof_demo: "Concept",
      proof_own: "My project",
      proof_private: "Private system",
      filter_apps: "Apps",
      filter_systems: "Systems",
      filter_marketing: "Marketing",
      feature_status: "Live site",
      feature_cat: "Website",
      feature_client: "Local client",
      feature_kicker: "Public case #01",
      feature_title: "UndergroundGym.pl",
      feature_desc: "Website for a local 24/7 gym: premium first impression, clear offer, pricing, reviews and a full contact path — from trial entry to form and map.",
      feature_li_1: "Offer and CTAs leading directly to trial entry.",
      feature_li_2: "Responsive desktop/mobile layout with a strong club identity.",
      feature_li_3: "External embeds (map) gated behind consent — GDPR-friendly.",
      feature_li_4: "SEO basics and Core Web Vitals treated as a launch standard.",
      open_live: "Open live site",
      role_label: "Role:",
      proof_label: "Proof:",
      status_label: "Status:",
      ask_scope: "Ask about scope",
      ug_title: "UndergroundGym.pl",
      ug_role: "UX + frontend + delivery",
      ug_meta: "Fitness / real client",
      ug_desc: "Conversion-focused website for a 24/7 gym. Offer, pricing, reviews, trial-entry form and contact path with GDPR-friendly embeds.",
      ug_metric: "live site / real client / public URL",
      prime_preview_label: "Concept",
      prime_status: "Concept",
      prime_cat_web: "Website",
      prime_cat_growth: "Fitness",
      prime_cat_mkt: "Repositioning",
      prime_title: "PrimeGym Rumia",
      prime_role: "Offer strategy, UX, web design, frontend, local SEO",
      prime_meta: "Fitness / concept",
      prime_desc: "Repositioning a local club from a standard gym into a premium fitness-lifestyle brand: new hero, offer structure, schedule and pricing, CTA paths and a conversion tracking plan.",
      prime_li_1: "Offer positioning: fitness + lifestyle club, Kids Zone, Akademia Prime, wellness/sauna",
      prime_li_2: "Landing pages and local SEO structure",
      prime_li_3: "CTA path to schedule, pass, contact and eFitness",
      prime_li_4: "Public signal audit, competitor map and campaign directions",
      prime_li_5: "Analytics event map and conversion tracking plan",
      prime_stack_meta: "Campaign plan",
      prime_stack_tracking: "Tracking plan",
      prime_metric: "concept / built and sent",
      prime_demo_btn: "Concept, not live",
      sudoku_preview_label: "My project",
      sudoku_status: "My project",
      ...
      trading_title: "Trading Workstation",
      trading_role: "Frontend architecture, UX systems, dashboard design, backend integration",
      trading_meta: "Dashboard / private system",
      trading_desc: "Local decision-support dashboard for conservative analysis: evidence retrieval, classifications (qualified_watchlist, weak_watchlist, no_trade), diagnostics and a workstation/cockpit UI redesign.",
      trading_li_1: "Chart-first layout with right-rail evidence and sample-count diagnostics",
      trading_li_2: "Decision classification UI with clear status hierarchy",
      trading_li_3: "Dark workstation/cockpit feel: Space Grotesk + IBM Plex Mono",
      trading_li_4: "Frontend refactor: DashboardView, RightRailSummary, ActionCard, PriceHistoryChart",
      trading_li_5: "Build/test validated — not a presentation of financial results",
      trading_metric: "private system / frontend validated with tests",
      private_repo: "Private repository",
      tw_svg_run: "RUN SCAN",
      tw_svg_decision: "QUALIFIED WATCHLIST",
      tw_svg_system: "PRIVATE SYSTEM",
}
  };
  ...
  function applyLang(lang){
    ...
    // Reveal text now that the resolved language is applied (anti-FOUC cloak)
    ...
    if (titleKey) {
      const t = dict[titleKey] || titleDefaults[lang]?.[titleKey];
      if (t) document.title = t;
    }
    const meta = document.querySelector('meta[name="description"]');
    if (meta && descKey) {
      const d = dict[descKey] || titleDefaults[lang]?.[descKey];
